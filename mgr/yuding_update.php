...
<body>
<?php
$row = $dosql->GetOne("SELECT * FROM `#@__yuding` WHERE `id`=$id");
?>
<div class="formHeader"> <span class="title">修改预订</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
<form name="form" id="form" method="post" action="yuding_save.php" onsubmit="return cfm_yuding();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		<tr>
			...
			<td width="75%"><strong><?php echo $row['linename'] ?></strong></td>
		</tr>
		<tr>
			<td height="40" align="right">联系人：</td>
			<td><input type="text" name="customer" id="customer" class="input" value="<?php echo $row['customer'] ?>" />
				<span class="maroon">*</span><span class="cnote">带<span class="maroon">*</span>号表示为必填项</span>
			</td>
		</tr>
		<tr>
			<td height="40" align="right">联系电话：</td>
			<td><input type="text" name="contact" id="contact" class="input" value="<?php echo $row['contact'] ?>" />
				<span class="maroon">*</span><span class="cnote">带<span class="maroon">*</span>号表示为必填项</span>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><textarea name="remark" id="remark"><?php echo $row['remark'] ?></textarea>
				<script>
				var editor;
				KindEditor.ready(function(K) {
