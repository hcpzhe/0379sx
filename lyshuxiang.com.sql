...
Source Database       : 0379sx.com

Target Server Type    : MYSQL
Target Server Version : 50516
File Encoding         : 65001

Date: 2015-04-12 03:08:58
*/
...
CREATE TABLE `dx_yuding` (
  ...
  `contact` varchar(50) NOT NULL COMMENT '联系方式',
  `content` text NOT NULL COMMENT '预订留言',
  `remark` text NOT NULL COMMENT '跟进备注',
  `retime` int(10) unsigned NOT NULL COMMENT '跟进时间',
  `orderid` mediumint(8) unsigned NOT NULL COMMENT '排列排序',
  `posttime` int(10) unsigned NOT NULL COMMENT '提交时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
